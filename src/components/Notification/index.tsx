...
const Notification = () => {
    ...
    return (
        <>
            <Popover>
                <PopoverButton onClick={() => setSelectedAnnouncement(null)} className="block text-sm/6 font-semibold text-black/50 focus:outline-none data-active:text-black data-focus:outline data-focus:outline-white data-hover:text-black">
                    ...
                    <div className="w-full h-full overflow-auto">
                        {
                            notificationList.map((announcement) => (
                                <div key={announcement.id} className={`p-3 border-b border-light-gray ${announcement.read?'bg-white':'bg-light-blue'}`}   onClick={() => handleItemClick(announcement)}>

...
const DogPaw = ({className}:Props) => {
    return (
        <div className={`relative w-40 h-40 flex justify-start items-center ${className}`}>
            ...
            <div className="absolute left-[15%] bottom-[58%] flex items-center justify-center w-8 h-[2.875rem] text-white">
                <img src={paw2} alt="" className="w-full h-full"/>
                <p className="absolute rotate-[-10deg]">2</p>
            </div>
            <div className="absolute left-[39%] bottom-[59%] flex items-center justify-center w-[2.0625rem] h-[2.8125rem] text-white">
                <img src={paw3} alt="" className="w-full h-full"/>
                <p className="absolute rotate-[20deg]">3</p>
            </div>
            <div className="absolute left-[54%] bottom-[38%] flex items-center justify-center w-[2.125rem] h-[2.5625rem] text-white">
                <img src={paw4} alt="" className="w-full h-full"/>
                <p className="absolute rotate-[20deg]">3</p>
            </div>
            <div className="absolute left-[14%] top-[50%] flex items-center justify-center w-[4.9375rem] h-[3.625rem] text-white">

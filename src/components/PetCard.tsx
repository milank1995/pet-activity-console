...
import InfoBlock from "./users/InfoBlock.tsx";
        ...
        <div className="w-[19.4375rem] bg-white rounded-[0.625rem]">
            ...
            <div className="px-5 pt-4 pb-8">
                <div className="flex flex-col gap-3 pb-5 text-dark-gray">
                    ...
                    <InfoBlock title="Date of birth" value= {`${birthDate} - ${age} old`} />
                </div>
                ...
                <div className="flex justify-between border-t pt-5 border-light-gray">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-purple text-xl font-bold leading-5">{totalStars}</p>
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-pink text-xl font-bold leading-5">{totalRedeemed}</p>
            ...
            <div className={`${bgColor} text-white text-xs font-semibold leading-[100%] text-center py-3 h-[2.4375rem]  border-bottom rounded-b-[0.625rem] flex items-center justify-center gap-1.5`}>
                <BellIconNew />
                Next treatment in <span className="font-extrabold">{nextTreatment}</span>
            </div>
        </div>
    );
};

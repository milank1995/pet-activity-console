...
import InfoBlock from "../../components/users/InfoBlock.tsx";
        ...
        <div className='h-100 flex flex-col gap-10 flex-1 overflow-auto no-scrollbar'>
            ...
            <div>
                <div className="flex items-center justify-between">
                    <Tabs tabs={rewardStarTabs} selectedIndex={selectedIndex} onTabChange={setSelectedIndex}/>
                    <div className="flex items-center gap-8">
                        <select className="w-[10.56rem] focus:outline-0 rounded px-2.5 py-[0.9375rem] text-dark-gray">
                            <option value="all-pets" selected>All pets</option>
                            <option value="recent">Recent</option>
                        </select>
                        {
                            selectedIndex === 0 &&
                            <p className="flex items-center gap-2.5">
                                <input type="checkbox" className="w-5 h-5 appearance-none text-purple bg-white checked:appearance-auto border-white rounded focus:ring-0" />

                                <span className="text-xs text-dark-gray font-normal">Show stars expired only</span>
                            </p>
                        }
                ...
                <TabPanel index={0} value={selectedIndex} className="mt-2.5">
                    <div className="bg-white w-full rounded-[0.625rem] ">
                        ...
                        <div className="border-t border-light-gray">
                            <TableContainer bodyData={rewardStarList} columns={starsTableColumns}/>
                        </div>
                    </div>
                </TabPanel>
            </div>
